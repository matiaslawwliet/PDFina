<div class="max-w-xl mx-auto p-6 bg-white/80 dark:bg-zinc-900/80 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 backdrop-blur-xl animate-fade-in">
    ...
    <form wire:submit.prevent="dividirPdf" class="space-y-6">
        ...
        <div class="flex gap-2">
            <div class="flex-1">
                <label class="block text-sm font-medium mb-1">Página inicio</label>
                <input type="number" wire:model="pagina_inicio" min="1"
            ...
            <div class="flex-1">
                <label class="block text-sm font-medium mb-1">Página fin</label>
                <input type="number" wire:model="pagina_fin" min="1"
                    class="w-full rounded-lg border-2 border-blue-200 dark:border-blue-700 bg-white dark:bg-zinc-800 text-gray-900 dark:text-gray-100 px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition shadow-sm"
                    placeholder="Ej: 5" />
                @error('pagina_fin')
                    <div class="text-red-500 text-sm animate-shake">{{ $message }}</div>
        ...
        <button type="submit" class="w-full py-3 bg-gradient-to-r from-blue-500 to-blue-700 dark:from-blue-800 dark:to-blue-600 text-white font-bold rounded-xl shadow-lg hover:scale-105 hover:from-blue-600 hover:to-blue-800 transition-all duration-300">Dividir PDF</button>
    </form>
