<div class="max-w-xl mx-auto p-6 bg-white/80 dark:bg-zinc-900/80 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 backdrop-blur-xl animate-fade-in">
    ...
    <div class="mb-4 p-3 bg-yellow-100 dark:bg-yellow-900/40 text-yellow-800 dark:text-yellow-200 rounded shadow text-sm">
        <b>Requisito:</b> Debes tener instalado <b>Ghostscript</b> en tu equipo para poder eliminar páginas de archivos PDF.<br>
    ...
    <form wire:submit.prevent="eliminarPaginas" class="space-y-6">
        <div>
        ...
        @if(!$nuevoPdfGenerado)
            <div class="mb-4">
                <label class="block text-sm font-medium mb-1">Ingresa las páginas a eliminar (separadas por coma, sin espacios)</label>
                <input type="text" wire:model="paginas"
        ...
        @endif
        <button type="submit" class="w-full py-3 bg-gradient-to-r from-blue-500 to-blue-700 dark:from-blue-800 dark:to-blue-600 text-white font-bold rounded-xl shadow-lg hover:scale-105 hover:from-blue-600 hover:to-blue-800 transition-all duration-300">Eliminar páginas</button>
    </form>
