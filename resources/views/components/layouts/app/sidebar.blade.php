...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.item icon="bug-ant" :href="route('reportar.problema')">
                    {{ __('Reportar un problema') }}
                </flux:navlist.item>
                <flux:navlist.item icon="chat-bubble-bottom-center-text" :href="route('enviar.sugerencia')">
                    {{ __('Envíar una sugerencia') }}
                </flux:navlist.item>
                <flux:navlist.item icon="trash" :href="route('dashboard', ['modulo' => 'limpieza'])" :current="request()->get('modulo') === 'limpieza'" wire:navigate>
                    {{ __('Vaciar papelera PDFina') }}
                </flux:navlist.item>
                <flux:navlist.item icon="book-open-text" href="https://github.com/matiaslawwliet/PDFina" target="_blank">
                    {{ __('Documentación') }}
                </flux:navlist.item>
            </flux:navlist>
